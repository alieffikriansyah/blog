        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table id="default-datatable" class="table table-bordered">
                    ...
                    <tbody>
                        <?php $i=1; ?>
                        <?php $__empty_1 = true; $__currentLoopData = $penilaian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if(isset($p->karyawan)): ?>
                        <tr>
                            <td><?php echo e($i); ?></td>
                            ...
                            <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $p->periode_penilaian)->format('F')); ?>
                            ...
                            <td style="text-align:center;">
                                <button class="btn btn-success waves-effect waves-light btn-detil" data-toggle="modal"
                                    data-target="#modalnilai" data-idform="<?php echo e($p->formPenilaian->idform_penilaian); ?>"
                                    data-id="<?php echo e($p->id_penilaian); ?>"> <i class="fa fa-plus"></i> Nilai</button>
                                
                                <button type="button" onclick="hapus('<?php echo e($p->id_penilaian); ?>')"
                        ...
                        <tr>
                            ...
                            <td><?php echo e($p->nama_departemen); ?></td>
                            <td><?php echo e($p->nama_jabatan); ?></td>
                            <td><?php echo e($p->nama_form_penilaian); ?></td>
                            <td><?php echo e($p->waktu_penilaian); ?></td>
                            <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $p->periode_penilaian)->format('F')); ?>
                            ...
                            <td style="text-align:center;">
                                <button class="btn btn-success waves-effect waves-light btn-detil" data-toggle="modal"
                                    data-target="#modalnilai" data-idform="<?php echo e($p->form_penilaian_idtable1); ?>"
                                    data-id="<?php echo e($p->id_penilaian); ?>"> <i class="fa fa-plus"></i> Nilai</button>
                ...
                <form method="POST" name="tbhAbsen" action="<?php echo e(route('penilaian.tambah')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="karyawan" required>
                            ...
                            <option value="<?php echo e($d->id_karyawan); ?>"><?php echo e($d->nama_departemen); ?> - <?php echo e($d->nama_jabatan); ?> -
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Arya\Downloads\cobabaru\cobabaru\blog\resources\views/penilaian.blade.php ENDPATH**/ ?>