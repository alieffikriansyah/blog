        ...
        <div class="table-responsive">
            ...
            <select id="month" name="month">
                ...
                <table id="default-datatable" class="table table-bordered">
                    ...
                    <tbody>
                        <?php $i=1; ?>
                        <?php $__currentLoopData = $PengajuanCuti; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($i); ?></td>
                            <td><?php echo e($cuti->karyawan->nama); ?></td>
                            <td><?php echo e($cuti->tanggal_mulai_cuti); ?></td>
                            <td><?php echo e($cuti->tanggal_mulai_cuti); ?></td>
                            <td><?php echo e($cuti->keterangan_cuti); ?></td>
                            <td><?php echo e($cuti->status_cuti); ?></td>
                            <td style="text-align:center;">
                            <button type="button" onclick="terima('<?php echo e($cuti->idpengajuan_cuti); ?>')" class="btn btn-success waves-effect waves-light"> <i class="fa fa-edit"></i> Terima</button>
                            <button type="button" onclick="tolak('<?php echo e($cuti->idpengajuan_cuti); ?>')" class="btn btn-danger waves-effect waves-light"> <i class="fa fa-edit"></i> Tolak</button>
...
<div class="modal fade" id="modaltambah">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" name="tbhAbsen" action="<?php echo e(route('pengajuanCuti.tambah')); ?>">
...
<div class="modal fade" id="modalubah">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" name="ubhAbsen" action="<?php echo e(route('pengajuanCuti.ubah')); ?>">
                <?php echo e(csrf_field()); ?>
...
<script>
    ...
    function absen($id_pengajuanCuti) {
        $.ajax({
            url: "<?php echo e(url('get_ubah_pengajuanCuti')); ?>/"+$id_pengajuanCuti,
            type: 'get',
            dataType: 'json',
    ...
    function getAbsen($day, $time) {
        $.ajax({
            url: "<?php echo e(url('get_absen_pengajuanCuti')); ?>/"+$day,
            type: 'get',
            dataType: 'json',
                    ...
                    columns: [
                        ...
                        { "data": "keterangan_cuti" },
                        {
                            ...
                            "render": function ( data, type, full, meta ) {
                                ...
                                var actionWidget  = `<button type="button" onclick="ubahAbsen('<?php echo e('${pengajuanCuti}'); ?>')" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalubah"> <i class="fa fa-edit"></i> Ubah</button>
                                            <button type="button" onclick="hapusAbsen('<?php echo e('${pengajuanCuti}'); ?>')" class="btn btn-danger waves-effect waves-light"> <i class="fa fa-trash"></i> Hapus</button>`;
                                return actionWidget;
                            },
                            "targets": -1
                        },
    ...
    function hapusAbsen($id_pengajuanCuti){
        ...
        dangerMode: true,
            ...
            if (willDelete) {
                window.location.href="<?php echo e(url('hapus_pengajuanCuti')); ?>/"+$id_pengajuanCuti;
                pageloader();
            } 
        });
    }
    ...
    function tolak($id_tolak){
        ...
        dangerMode: true,
            ...
            if (willDelete) {
                ...
                window.location.href="<?php echo e(url('tolak_pengajuanCuti')); ?>/"+$id_tolak;
                pageloader();
            } 
        });
    }
    ...
    function terima($id_terima){
        ...
        dangerMode: true,
            ...
            if (willDelete) {
                window.location.href="<?php echo e(url('terima_pengajuanCuti')); ?>/"+$id_terima;
                pageloader();
            } 
        });
    }
    ...
    function changePage(){
        ...
        var url = "<?php echo e(route('pengajuanCuti.with.date')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Arya\Downloads\cobabaru\cobabaru\blog\resources\views/PengajuanCuti.blade.php ENDPATH**/ ?>