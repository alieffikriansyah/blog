                ...
                <table id="default-datatable" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button type="button" onclick="getAbsen('<?php echo e($day); ?>', '<?php echo e($arrTimes[$i-1]); ?>')" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalabsen"> <i class="fa fa-edit"></i> Detail</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
        ...
        <div class="row pt-2 pb-3">
            ...
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <button id="button-tambah-absen" type="button" class="btn btn-success waves-effect waves-light m-1" data-toggle="modal" data-target="#modaltambah"> <i class="fa fa fa-plus"></i> Tambah</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-body">
            <form method="POST" name="tbhAbsen" action="<?php echo e(route('absensi.tambah')); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-12" name="keterangan_absensi" placeholder="Keterangan Absensi....">
                </div>

                <div class="form-group">
                    <label for="input-1">Tanggal dan Waktu Absensi<span style="color: #ff5252;">*</span></label>
                    <input type="text" class="form-control" id="input-1" required readonly name="tanggaldanwaktu_absensi" placeholder="yyyy-mm-dd hh:mm:ss">
                </div>
                ...
                <div class="btn-group float-sm-right mt-2">
                    <button onclick="validateForm('ubhAbsensi', 'karyawan', 'tipe_absensi', 'tanggaldanwaktu_absensi', 'tipe_absensi')" type="submit" class="btn btn-success px-5">Simpan</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-body">
            <form method="POST" name="ubhAbsen" action="<?php echo e(route('absensi.ubah')); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-12" name="keterangan_absensi_ubah" placeholder="Keterangan Absensi....">
                </div>
        
                <div class="form-group">
                    <label for="input-1">Tanggal dan Waktu Absensi<span style="color: #ff5252;">*</span></label>
                    <input type="text" class="form-control" id="input-1" required readonly name="tanggaldanwaktu_absensi_ubah" placeholder="yyyy-mm-dd hh:mm:ss">
                </div>
                    ...
                    columns: [
                        ...
                        { "data": "keterangan_cuti" },
                        {
                            ...
                            "render": function ( data, type, full, meta ) {
                                var absensi = data.id_absensi;
                                var actionWidget  = `<button type="button" onclick="ubahAbsen('<?php echo e('${absensi}'); ?>')" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalubah"> <i class="fa fa-edit"></i> Ubah</button>
                                            <button type="button" onclick="hapusAbsen('<?php echo e('${absensi}'); ?>')" class="btn btn-danger waves-effect waves-light"> <i class="fa fa-trash"></i> Hapus</button>`;
                                return actionWidget;
                            },
                            "targets": -1
                        },
            ...
            success: function(res){
                ...
                for (let $i=0; $i<status_tipe_absensis.length; $i++) {
                    if(status_tipe_absensis[$i]==res['tipe_absensi']){
                        $('select[name*="tipe_absensi_ubah"]').append('<option selected value="'+res['tipe_absensi']+'">'+res['tipe_absensi']+'</option>');
                    }else{
                        $('select[name*="tipe_absensi_ubah"]').append('<option value="'+status_tipe_absensis[$i]+'">'+status_tipe_absensis[$i]+'</option>');
                    }
                }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SMT 10\TA\Program\cobabaru\blog\resources\views/absensi.blade.php ENDPATH**/ ?>