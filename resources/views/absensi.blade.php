                ...
                <table id="default-datatable" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button type="button" onclick="getAbsen('{{ $day }}', '{{ $arrTimes[$i-1] }}')" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalabsen"> <i class="fa fa-edit"></i> Detail</button>
                            </td>
                        </tr>
                        @php $i++; @endphp
                        @endforeach
                    ...
                    columns: [
                        ...
                        { "data": "keterangan_cuti" },
                        {
                            ...
                            "render": function ( data, type, full, meta ) {
                                ...
                                var actionWidget  = `<button type="button" onclick="ubahAbsen('{{ '${absensi}' }}')" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalubah"> <i class="fa fa-edit"></i> Ubah</button>
                                            <button type="button" onclick="hapusAbsen('{{ '${absensi}' }}')" class="btn btn-danger waves-effect waves-light"> <i class="fa fa-trash"></i> Hapus</button>`;
                                return actionWidget;
                            },
                            "targets": -1
                        },
