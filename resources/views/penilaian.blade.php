      ...
      <div class="card-body">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $p->periode_penilaian)->format('F')}}</td>
                <td>{{$p->nilai_skor}}</td>
                <td>{{$p->nama_penilai}}</td>
                <td style="text-align:center;">
                <button  class="btn btn-success waves-effect waves-light btn-detil"  data-toggle="modal" data-target="#modalnilai"  data-idform="{{$p->formPenilaian->idform_penilaian}}" data-id="{{$p->id_penilaian}}"> <i class="fa fa-plus"></i> Nilai</button>
                {{-- <button type="button" class="btn btn-warning waves-effect waves-light btn-edit"  data-toggle="modal" data-target="#modalubah" data-id="{{ $p->id_penilaian }}"> <i class="fa fa-edit"></i> Update</button> --}}
                <button type="button" onclick="hapus('{{ $p->id_penilaian }}')" class="btn btn-danger waves-effect waves-light"> <i class="fa fa-trash"></i> Hapus</button>
