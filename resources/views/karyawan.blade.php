          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <button type="button"  class="btn btn-warning waves-effect waves-light btn-edit" data-id="{{$kat->id_karyawan}}" data-toggle="modal" data-target="#modalubah"> <i class="fa fa-edit"></i> Ubah</button>
                    <button type="button" class="btn btn-danger waves-effect waves-light btn-delete" data-id="{{$kat->id_karyawan}}"> <i class="fa fa-trash"></i> Hapus</button>
                    </td>
                </tr>
                @php $i++; @endphp
                @endforeach
